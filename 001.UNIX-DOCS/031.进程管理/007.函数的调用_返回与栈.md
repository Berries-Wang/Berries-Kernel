# 函数的调用、返回与栈
> 学习: <br/> - [硬件环境与软件抽象：ARM指令集架构 # >=P45](../../001.UNIX-DOCS/000.内存管理/998.REFS/000.中山大学-操作系统/2-0303-hardware-isa.pdf) <br/> - [Arm® Architecture Reference Manualfor A-profile architecture](../../007.BOOKs/Arm%20Architecture%20Reference%20Manual%20for%20A-profile%20architecture/) <br/> - [Run Linux Kernel (2nd Edition) Volume 1: Infrastructure.epub]#1.6　函数调用标准和栈布局
