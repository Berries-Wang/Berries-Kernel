...
> 在Linux内核中，SMP和NUMA是可同时存在的，且是共生的: NUMA 是多个 SMP 节点通过高速互联组成的更大系统 , 见:<br/>- [017.SMP负载均衡.md](./017.SMP负载均衡.md) <br/>- [Run Linux Kernel (2nd Edition) Volume 1: Infrastructure.epub#图8.18　调度域和调度组的关系]
