...
结合[Run Linux Kernel (2nd Edition) Volume 1: Infrastructure.epub]#2.1　ARM64内存管理 & [虚拟内存管理I](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf) & [虚拟内存管理II](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0313-virtual-mem-2.pdf)来学习理解
...
|序号|内容|备注|参考资料|
|-|-|-|-|
|0|- ![页表&页表项](../999.IMGS/20250814200211.jpg)|-|-|
|1|- ![wechat_2025-12-09_211221_706.png](../999.IMGS/wechat_2025-12-09_211221_706.png)|-|[虚拟内存管理](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf)|
|2|- ![wechat_2025-12-09_211647_303.png](../999.IMGS/wechat_2025-12-09_211647_303.png)|- 0级页表只有一个|[虚拟内存管理](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf)|
|3|- ![wechat_2025-12-09_211842_761.png](../999.IMGS/wechat_2025-12-09_211842_761.png)|-|[虚拟内存管理](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf)|
|4|- ![Huge Page](../999.IMGS/huge_page_20251211080143_88.jpg)|- (2M: 512(页表项数量) * 4K(page)) |[虚拟内存管理](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf)|
|5|- ![wechat_2026-01-25_175814_152.png](../999.IMGS/wechat_2026-01-25_175814_152.png)|权限管理|参考手册:[Arm® Architecture Reference Manualfor A-profile architecture](../../../007.BOOKs/Arm%20Architecture%20Reference%20Manual%20for%20A-profile%20architecture/)|
|6|- ![wechat_2026-01-27_082429_537.png](../999.IMGS/wechat_2026-01-27_082429_537.png)|页表与TLB |参考手册:[003.高速缓存/007.TLB.md](../003.高速缓存/007.TLB.md)|
|-|-|-|-|

  + 页表的级数和所采用的物理地址的位数相关: [000.SOURCE_CODE/000.LINUX-5.9/000.LINUX-5.9/arch/arm64/include/asm/pgtable-types.h]
    - CONFIG_PGTABLE_LEVELS 这个值是在 ‘menuconfig’ 即编译内核时确定的,比如，在 make menuconfig 时选择了 ARM64_VA_BITS_48 
###### 具体翻译流程
...
- 搜索上面表格中的 "0级页表只有一个" 
  + ![wechat_2025-12-09_211647_303.png](../999.IMGS/wechat_2025-12-09_211647_303.png)

---

## L0～L2页表项包含了指向下一级页表的基地址，那么这个下一级页表基地址采用的是物理地址还是虚拟地址？
> 物理地址，详见:[Run Linux Kernel (2nd Edition) Volume 1: Infrastructure.epub]#2.7.1　关于下一级页表基地址 ， 答案: "物理地址"
- ![wechat_2026-01-27_231620_374.png](../999.IMGS/wechat_2026-01-27_231620_374.png) : [虚拟内存管理II](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0313-virtual-mem-2.pdf)

那既然是物理地址，在开启了MMU后，CPU只能处理虚拟地址，那么物理地址该如何处理呢? —— 答案:  "线性映射区域" (内存映射的一种方式)

- ![wechat_2026-01-27_225652_662.png](../999.IMGS/wechat_2026-01-27_225652_662.png)
- 学习:[虚拟内存管理II](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0313-virtual-mem-2.pdf)

先阅读上述内容，得知：
- 页表中的页表项存储的是物理地址！
- 开启了MMU后，CPU只能处理虚拟地址！

那么问题就是： 既然页表项中存储的物理地址，而使能了MMU的CPU只能处理虚拟地址，那究竟如何处理？总不能此时将MMU关闭吧？这不现实。 答案: “线性映射区域” (内存映射的一种方式)：
- 只需要将物理地址与偏移量<sup>偏移量: 线性映射区域的虚拟地址和物理地址的偏移量;</sup>进行运算<sup>运算: 加/减</sup>，那么就可以得到对应的内核虚拟地址，再通过MMU进行地址转换，从而得到物理地址 <sup>参考: [Run Linux Kernel (2nd Edition) Volume 1: Infrastructure.epub#2.7.2　软件遍历页表](../../007.BOOKs/Run%20Linux%20Kernel%20(2nd%20Edition)%20Volume%201:%20Infrastructure.epub) : "在PGD页表项中存储了指向下一级页表基地址的物理地址，因此通过__va()宏，可以快速地把物理地址转换成内核空间的虚拟地址，从而找到下一级页表基地址的虚拟地址"</sup>
```c
...
- [虚拟内存管理I](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0310-virtual-mem-1.pdf) 
- [虚拟内存管理II](../../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/3-0313-virtual-mem-2.pdf)
