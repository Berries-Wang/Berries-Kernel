...
### 不同虚拟机内的进程如何切换? <sup>[23-虚拟化：CPU虚拟化 [中山大学 操作系统原理]](../000.内存管理/998.REFS/000.中山大学-操作系统/14-0526-virt-2.pdf)</sup>
