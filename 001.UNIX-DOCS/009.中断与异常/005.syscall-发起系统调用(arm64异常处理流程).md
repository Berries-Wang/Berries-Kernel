...
> 在Linux中，通过 man 2 syscall 了解 syscall , 通过[write函数](./003.通过write函数分析从GLIBC到内核的调用链路.md)来分析 <br/> - [001.UNIX-DOCS/001.操作系统课程/001.中山大学-操作系统2026/第二周：硬件环境与软件抽象-特权级模型与中断.pdf](../../001.UNIX-DOCS/001.操作系统课程/001.中山大学-操作系统2026/第二周：硬件环境与软件抽象-特权级模型与中断.pdf) <br/> - [现代操作系统：原理与实现<sup>陈海波 夏虞斌</sup>] <br/> - [硬件环境与软件抽象：特权级模型与中断](../../001.UNIX-DOCS/001.操作系统课程/000.中山大学-操作系统2025/2-0306-hardware-interrupt.pdf)
